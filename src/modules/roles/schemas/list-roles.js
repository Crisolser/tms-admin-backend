...
export const ListRolesSchema = z.object({
   ...
   page: z
      ...
      .default(1)
      .optional(),
   name: z.string().max(100, { message: 'Debe tener máximo 100 caracteres' }).trim().optional(),
   id: z.string().regex(/^\d+$/, { message: 'Debe ser un número válido' }).transform(Number).optional(),
});
