...
export const CreateAdminSchema = z
   .object({
      ...
      email: z.email({ message: 'Debe ser un correo electrónico válido' }).toLowerCase().max(100, { message: 'Debe tener máximo 100 caracteres' }),
      phone: z
         .string()
      ...
      status: z
         ...
         .refine(val => LIST_STATUS.includes(val), { message: 'Estado de cuenta inválido, opciones disponibles ' + LIST_STATUS_OPTIONS })
         .default(1)
         .optional(),
   })
   .strict();
